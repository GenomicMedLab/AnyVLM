"""Module for deploying AnyVLM EB environment."""
import time
...
terminate_time = 12
eb_app_name = "AnyVLM"
eb_env_name = "anyvlm-prod-env"
sc_product_id = "prod-o5lzrjhpelhdc"
print(
    f"Launching new Service Catalog Product for prod environment: {eb_app_name}"
)
